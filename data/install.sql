...
-- 积分交易表
CREATE TABLE IF NOT EXISTS credits_trans (
  id SERIAL PRIMARY KEY,
  uuid VARCHAR(255) UNIQUE NOT NULL,
  user_uuid VARCHAR(255) NOT NULL,
  trans_type VARCHAR(50) NOT NULL,
...
-- 创建索引
CREATE INDEX IF NOT EXISTS credits_trans_user_uuid_idx ON credits_trans(user_uuid);
CREATE INDEX IF NOT EXISTS credits_trans_created_at_idx ON credits_trans(created_at);